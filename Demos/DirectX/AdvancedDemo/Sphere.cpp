...
void Sphere::Create(ComPtr<ID3D11DeviceContext1> &d3dDeviceContext)
{
	this->sphere = GeometricPrimitive::CreateSphere(d3dDeviceContext.Get(),0.7f);
}

void Sphere::Draw(CXMMATRIX world, CXMMATRIX view, CXMMATRIX projection, FXMVECTOR color, ID3D11ShaderResourceView* texture)
{
	this->sphere->Draw(world * this->modelMatrix, view, projection, color, texture);
}
