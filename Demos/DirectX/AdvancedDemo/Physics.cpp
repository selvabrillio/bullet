	...
	m_solver(new btSequentialImpulseConstraintSolver)
{
	...
	m_dynamicsWorld->setGravity(btVector3(0,-1.0f,0));
}

void Physics::SetGravity(const btVector3& gravityVector)
{
	m_dynamicsWorld->setGravity(gravityVector);
}
...
void Physics::Update()
{
    m_dynamicsWorld->stepSimulation(1/5.f,10);
}
